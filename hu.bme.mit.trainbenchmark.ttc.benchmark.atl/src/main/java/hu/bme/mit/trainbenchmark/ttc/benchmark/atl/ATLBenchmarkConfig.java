...
public class ATLBenchmarkConfig extends BenchmarkConfig {

	public ATLBenchmarkConfig(final String[] args) throws ParseException {
		super(args);
	}

	public ATLBenchmarkConfig(final int size, final int runs, final String query, final int iterationCount, final ChangeSet changeSet,
