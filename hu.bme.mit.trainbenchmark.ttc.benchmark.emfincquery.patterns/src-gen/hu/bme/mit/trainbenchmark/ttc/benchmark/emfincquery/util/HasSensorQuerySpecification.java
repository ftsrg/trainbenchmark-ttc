...
import hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.HasSensorMatch;
import hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.HasSensorMatcher;
...
public final class HasSensorQuerySpecification extends BaseGeneratedEMFQuerySpecification<HasSensorMatcher> {
  ...
  public HasSensorMatch newMatch(final Object... parameters) {
    return HasSensorMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.TrackElement) parameters[0]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.hasSensor";
    }
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("sw", "hu.bme.mit.trainbenchmark.ttc.railway.TrackElement"));
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new TypeConstraint(body, new FlatTuple(var_sw, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.semanticweb.org/ontologies/2015/ttc/trainbenchmark", "TrackElement", "sensor")));
