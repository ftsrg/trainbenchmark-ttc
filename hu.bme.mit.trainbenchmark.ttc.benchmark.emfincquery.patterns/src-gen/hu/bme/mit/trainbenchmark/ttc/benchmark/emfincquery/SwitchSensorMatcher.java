...
/**
 * Generated pattern matcher API of the hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.SwitchSensor pattern,
...
public class SwitchSensorMatcher extends BaseMatcher<SwitchSensorMatch> {
  ...
  protected SwitchSensorMatch arrayToMatch(final Object[] match) {
    try {
    	return SwitchSensorMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.Switch) match[POSITION_SW]);
    } catch(ClassCastException e) {
  ...
  protected SwitchSensorMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return SwitchSensorMatch.newMutableMatch((hu.bme.mit.trainbenchmark.ttc.railway.Switch) match[POSITION_SW]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
