...
import hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.EntrySemaphoreMatcher;
...
public final class EntrySemaphoreQuerySpecification extends BaseGeneratedEMFQuerySpecification<EntrySemaphoreMatcher> {
  ...
  public EntrySemaphoreMatch newMatch(final Object... parameters) {
    return EntrySemaphoreMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.Route) parameters[0], (hu.bme.mit.trainbenchmark.ttc.railway.Semaphore) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.entrySemaphore";
    }
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("route", "hu.bme.mit.trainbenchmark.ttc.railway.Route"),new PParameter("semaphore", "hu.bme.mit.trainbenchmark.ttc.railway.Semaphore"));
    }
