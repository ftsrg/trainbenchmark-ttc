...
/**
 * Pattern-specific match representation of the hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.switchSet pattern,
...
public abstract class SwitchSetMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("swP".equals(parameterName) ) {
    	this.fSwP = (hu.bme.mit.trainbenchmark.ttc.railway.SwitchPosition) newValue;
    	return true;
    }
