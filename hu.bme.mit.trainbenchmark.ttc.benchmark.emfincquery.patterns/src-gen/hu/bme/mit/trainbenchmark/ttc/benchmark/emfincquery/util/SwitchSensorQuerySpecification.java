...
public final class SwitchSensorQuerySpecification extends BaseGeneratedEMFQuerySpecification<SwitchSensorMatcher> {
  ...
  public SwitchSensorMatch newMatch(final Object... parameters) {
    return SwitchSensorMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.Switch) parameters[0]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("sw", "hu.bme.mit.trainbenchmark.ttc.railway.Switch"));
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new TypeUnary(body, var_sw, getClassifierLiteral("http://www.semanticweb.org/ontologies/2015/ttc/trainbenchmark", "Switch"), "http://www.semanticweb.org/ontologies/2015/ttc/trainbenchmark/Switch");
