...
import hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.EntrySemaphoreSensorMatcher;
...
public final class EntrySemaphoreSensorQuerySpecification extends BaseGeneratedEMFQuerySpecification<EntrySemaphoreSensorMatcher> {
  ...
  public EntrySemaphoreSensorMatch newMatch(final Object... parameters) {
    return EntrySemaphoreSensorMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.Semaphore) parameters[0], (hu.bme.mit.trainbenchmark.ttc.railway.Sensor) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.entrySemaphoreSensor";
    }
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("semaphore", "hu.bme.mit.trainbenchmark.ttc.railway.Semaphore"),new PParameter("sensor2", "hu.bme.mit.trainbenchmark.ttc.railway.Sensor"));
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new TypeBinary(body, CONTEXT, var_route2, var_semaphore, getFeatureLiteral("http://www.semanticweb.org/ontologies/2015/ttc/trainbenchmark", "Route", "entry"), "http://www.semanticweb.org/ontologies/2015/ttc/trainbenchmark/Route.entry");
