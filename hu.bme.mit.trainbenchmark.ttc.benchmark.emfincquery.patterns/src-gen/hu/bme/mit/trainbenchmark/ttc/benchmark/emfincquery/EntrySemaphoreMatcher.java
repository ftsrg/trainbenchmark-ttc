...
/**
 * Generated pattern matcher API of the hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.entrySemaphore pattern,
...
public class EntrySemaphoreMatcher extends BaseMatcher<EntrySemaphoreMatch> {
  ...
  protected EntrySemaphoreMatch arrayToMatch(final Object[] match) {
    try {
    	return EntrySemaphoreMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.Route) match[POSITION_ROUTE], (hu.bme.mit.trainbenchmark.ttc.railway.Semaphore) match[POSITION_SEMAPHORE]);
    } catch(ClassCastException e) {
  ...
  protected EntrySemaphoreMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return EntrySemaphoreMatch.newMutableMatch((hu.bme.mit.trainbenchmark.ttc.railway.Route) match[POSITION_ROUTE], (hu.bme.mit.trainbenchmark.ttc.railway.Semaphore) match[POSITION_SEMAPHORE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
