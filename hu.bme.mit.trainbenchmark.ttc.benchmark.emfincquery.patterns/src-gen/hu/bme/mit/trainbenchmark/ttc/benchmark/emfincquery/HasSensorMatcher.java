...
import hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.util.HasSensorQuerySpecification;
...
/**
 * Generated pattern matcher API of the hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.hasSensor pattern,
...
public class HasSensorMatcher extends BaseMatcher<HasSensorMatch> {
  ...
  protected HasSensorMatch arrayToMatch(final Object[] match) {
    try {
    	return HasSensorMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.TrackElement) match[POSITION_SW]);
    } catch(ClassCastException e) {
  ...
  protected HasSensorMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return HasSensorMatch.newMutableMatch((hu.bme.mit.trainbenchmark.ttc.railway.TrackElement) match[POSITION_SW]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
