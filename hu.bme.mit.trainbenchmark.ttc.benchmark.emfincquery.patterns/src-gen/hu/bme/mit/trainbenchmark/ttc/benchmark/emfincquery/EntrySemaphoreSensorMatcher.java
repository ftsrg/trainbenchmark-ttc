...
import hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.EntrySemaphoreSensorMatch;
import hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.util.EntrySemaphoreSensorQuerySpecification;
...
/**
 * Generated pattern matcher API of the hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.entrySemaphoreSensor pattern,
...
public class EntrySemaphoreSensorMatcher extends BaseMatcher<EntrySemaphoreSensorMatch> {
  ...
  protected EntrySemaphoreSensorMatch tupleToMatch(final Tuple t) {
    try {
    	return EntrySemaphoreSensorMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.Semaphore) t.get(POSITION_SEMAPHORE), (hu.bme.mit.trainbenchmark.ttc.railway.Sensor) t.get(POSITION_SENSOR2));
  ...
  protected EntrySemaphoreSensorMatch arrayToMatch(final Object[] match) {
    try {
    	return EntrySemaphoreSensorMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.Semaphore) match[POSITION_SEMAPHORE], (hu.bme.mit.trainbenchmark.ttc.railway.Sensor) match[POSITION_SENSOR2]);
    } catch(ClassCastException e) {
  ...
  protected EntrySemaphoreSensorMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return EntrySemaphoreSensorMatch.newMutableMatch((hu.bme.mit.trainbenchmark.ttc.railway.Semaphore) match[POSITION_SEMAPHORE], (hu.bme.mit.trainbenchmark.ttc.railway.Sensor) match[POSITION_SENSOR2]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
