...
/**
 * Pattern-specific match representation of the hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.hasSensor pattern,
...
public abstract class HasSensorMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("sw".equals(parameterName) ) {
    	this.fSw = (hu.bme.mit.trainbenchmark.ttc.railway.TrackElement) newValue;
    	return true;
    }
    return false;
  }
