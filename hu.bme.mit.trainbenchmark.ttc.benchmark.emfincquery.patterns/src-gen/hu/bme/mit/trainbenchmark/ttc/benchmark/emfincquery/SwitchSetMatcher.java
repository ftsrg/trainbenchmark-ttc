...
public class SwitchSetMatcher extends BaseMatcher<SwitchSetMatch> {
  ...
  protected SwitchSetMatch arrayToMatch(final Object[] match) {
    try {
    	return SwitchSetMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.Semaphore) match[POSITION_SEMAPHORE], (hu.bme.mit.trainbenchmark.ttc.railway.Route) match[POSITION_ROUTE], (hu.bme.mit.trainbenchmark.ttc.railway.SwitchPosition) match[POSITION_SWP], (hu.bme.mit.trainbenchmark.ttc.railway.Switch) match[POSITION_SW]);
    } catch(ClassCastException e) {
