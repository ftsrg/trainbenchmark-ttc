...
public class SwitchSetMatcher extends BaseMatcher<SwitchSetMatch> {
  ...
  protected SwitchSetMatch tupleToMatch(final Tuple t) {
    try {
    	return SwitchSetMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.SwitchPosition) t.get(POSITION_SWITCHPOSITION));
  ...
  protected SwitchSetMatch arrayToMatch(final Object[] match) {
    try {
    	return SwitchSetMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.SwitchPosition) match[POSITION_SWITCHPOSITION]);
    } catch(ClassCastException e) {
  ...
  protected SwitchSetMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return SwitchSetMatch.newMutableMatch((hu.bme.mit.trainbenchmark.ttc.railway.SwitchPosition) match[POSITION_SWITCHPOSITION]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
