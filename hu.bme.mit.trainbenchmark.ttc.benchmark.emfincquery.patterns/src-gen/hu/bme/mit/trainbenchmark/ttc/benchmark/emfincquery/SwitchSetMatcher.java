...
/**
 * Generated pattern matcher API of the hu.bme.mit.trainbenchmark.ttc.benchmark.emfincquery.switchSet pattern,
...
public class SwitchSetMatcher extends BaseMatcher<SwitchSetMatch> {
  ...
  protected SwitchSetMatch tupleToMatch(final Tuple t) {
    try {
    	return SwitchSetMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.Semaphore) t.get(POSITION_SEMAPHORE), (hu.bme.mit.trainbenchmark.ttc.railway.Route) t.get(POSITION_ROUTE), (hu.bme.mit.trainbenchmark.ttc.railway.SwitchPosition) t.get(POSITION_SWITCHPOSITION), (hu.bme.mit.trainbenchmark.ttc.railway.Switch) t.get(POSITION_SW));
  ...
  protected SwitchSetMatch arrayToMatch(final Object[] match) {
    try {
    	return SwitchSetMatch.newMatch((hu.bme.mit.trainbenchmark.ttc.railway.Semaphore) match[POSITION_SEMAPHORE], (hu.bme.mit.trainbenchmark.ttc.railway.Route) match[POSITION_ROUTE], (hu.bme.mit.trainbenchmark.ttc.railway.SwitchPosition) match[POSITION_SWITCHPOSITION], (hu.bme.mit.trainbenchmark.ttc.railway.Switch) match[POSITION_SW]);
    } catch(ClassCastException e) {
  ...
  protected SwitchSetMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return SwitchSetMatch.newMutableMatch((hu.bme.mit.trainbenchmark.ttc.railway.Semaphore) match[POSITION_SEMAPHORE], (hu.bme.mit.trainbenchmark.ttc.railway.Route) match[POSITION_ROUTE], (hu.bme.mit.trainbenchmark.ttc.railway.SwitchPosition) match[POSITION_SWITCHPOSITION], (hu.bme.mit.trainbenchmark.ttc.railway.Switch) match[POSITION_SW]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
