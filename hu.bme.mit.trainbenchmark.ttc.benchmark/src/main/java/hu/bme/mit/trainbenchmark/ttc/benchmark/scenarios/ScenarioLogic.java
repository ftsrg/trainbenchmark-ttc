...
public class ScenarioLogic {
	...
	public BenchmarkResult runBenchmark(final BenchmarkConfig bc, final AbstractBenchmarkCase testCase, final int runIndex)
			throws IOException {
		testCase.benchmarkInit(bc, runIndex);
