...
public interface Segment extends TrackElement {
	 ...
	 * @see #setLength(int)
	 * @see hu.bme.mit.trainbenchmark.ttc.railway.RailwayPackage#getSegment_Length()
	 * @model required="true"
	 * @generated
	 */
	int getLength();
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.trainbenchmark.ttc.railway.Segment#getLength <em>Length</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
