 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.trainbenchmark.ttc.railway.Switch#getCurrentPosition <em>Current Position</em>}</li>
 *   <li>{@link hu.bme.mit.trainbenchmark.ttc.railway.Switch#getPositions <em>Positions</em>}</li>
 * </ul>
 *
 * @see hu.bme.mit.trainbenchmark.ttc.railway.RailwayPackage#getSwitch()
 * @model
 * @generated
 */
public interface Switch extends TrackElement {
	 ...
	 * @see hu.bme.mit.trainbenchmark.ttc.railway.RailwayPackage#getSwitch_CurrentPosition()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.trainbenchmark.ttc.railway.Switch#getCurrentPosition <em>Current Position</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link hu.bme.mit.trainbenchmark.ttc.railway.SwitchPosition#getSwitch <em>Switch</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see hu.bme.mit.trainbenchmark.ttc.railway.RailwayPackage#getSwitch_Positions()
